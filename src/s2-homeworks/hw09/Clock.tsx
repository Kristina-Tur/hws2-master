...
function Clock() {
    ...
    const formatter1 = new Intl.DateTimeFormat("ru-Ru");
    ...
    const stringDate = formatter1.format(date) // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
    ...
    return (
        <div className={s.clock}>
            ...
            <div className={s.buttonsContainer}>
                <SuperButton
                    id={'hw9-button-start'}
                    className={timerId !== undefined ? s.buttonDisabled : s.button}
